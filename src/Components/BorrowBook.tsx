...
function BorrowBook({accessToken}) {
...
const apiFunction = async ( username: string , bookname: string, startdate: string, enddate: string  ) => {
  ...
  const ToastSuccess = () => {
    toast.success("Book Register Successfull", { 
      autoClose: 3000
   });
  }
  const ToastAlert = () => {
        ...
        {showError && (
          ...
          <Form>
            ...
            <Form.Group controlId="bookName" className="mb-3">
              ...
              <Form.Control type="text" placeholder="Enter Book Name" value={bookname} onChange={(e) => setBookName(e.target.value)} list="books" />
              <datalist id="books">
            ...
            <Form.Group controlId="startdate" className="mb-3">
              ...
              <Form.Control type="date" placeholder="Enter Book Name" onChange={(e) => setStartDate(e.target.value)} />
            </Form.Group>
            <Form.Group controlId="enddate" className="mb-3">
              <Form.Label style={{ fontWeight: '600' }}>End-Date</Form.Label>
              <Form.Control type="date" placeholder="Enter Book Name" onChange={(e) => setEndDate(e.target.value)} />
            </Form.Group>


            <div className="text-center py-2 mt-2">
              <Button className="btn btn-primary-opacity-5" type="submit" onClick={(e) => handleSubmit(e)}>
                Submit
              </Button>
            </div>
          </Form>
